...
## [2.1.9] - 2026-07-06
### Added
- **Підказка про часове згасання (Decay Tooltip)**: Додано інтерактивну підказку (кнопку ℹ️) біля QRank у модальному вікні профілю. Вона відображає детальний математичний розрахунок з урахуванням згасання: рейтинг без згасання, фактичний рейтинг та загальну втрату від згасання у балах та відсотках.

## [2.0.8] - 2026-06-23
### Changed
- **Винесення елементів керування з картки**: Перенесено іконку інформації ℹ️ та перемикач мов UA | EN вище, поза межі картки заголовка, у нову панель `.top-bar`.
- **Оптимізація відступів**: Видалено абсолютне позиціонування елементів та скориговано верхній відступ заголовка для покращення симетрії інтерфейсу.
