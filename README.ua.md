...
*   📊 **Інтерактивна розшифровка балів**: Натисніть на картку будь-якого учасника, щоб миттєво побачити повну структуру його рейтингу (кількість повідомлень, відповідей та реакцій за трьома категоріями: Гуру, Флудер та Скептик). Також додано інтерактивну **підказку часу згасання (v2.1.9)**, яка детально показує втрату очок через вік повідомлень.
...
## 🚀 Швидке розгортання (One-Line Install)

Розгорніть усе миттєво однією командою:
